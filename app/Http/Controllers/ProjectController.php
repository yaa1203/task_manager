...
{
    /**
     * User: tampilkan project milik user yang login
     */
    ...
    {
        $project->delete();
        return redirect()->route('project.index')->with('success', 'Project deleted successfully by Admin.');
    }
}
