    ...
    <div class="mb-6 sm:mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-1.5 sm:mb-2">Buat Workspace Baru</h1>
                    <p class="text-xs sm:text-sm lg:text-base text-gray-600">Siapkan workspace baru untuk mengatur tugas Anda</p>
                </div>
            </div>
        </div>
    </div>
