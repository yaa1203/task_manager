            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-5">
                    ...
                    @if($task->file_path || $task->link)
                        <div>
                            <label class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2 block">Task Materials</label>
                            <div class="space-y-2">
                                @if($task->file_path)
                                    <div class="p-3 bg-gray-50 rounded-lg border border-gray-200">
                                        <div class="flex items-center gap-3 mb-2">
                                            ...
                                            <span class="text-sm text-gray-700 flex-1">{{ basename($task->file_path) }}</span>
                                        </div>
                                        <div class="flex gap-2">
                                            <a href="{{ route('workspace.tasks.view', [$workspace, $task]) }}" 
                                               target="_blank"
                                               class="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition text-sm font-medium">
                                            ...
                                            <a href="{{ route('workspace.tasks.download', [$workspace, $task]) }}" 
                                               class="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition text-sm font-medium">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                @if($task->link)
                                    <a href="{{ $task->link }}" 
                                       target="_blank"
                                       class="flex items-center gap-2 p-3 bg-blue-50 rounded-lg border border-blue-200 hover:border-blue-300 transition">
                                        <svg class="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path>
                                        </svg>
                                        <span class="text-sm text-blue-700 truncate">{{ $task->link }}</span>
                                    </a>
                                @endif
                            </div>
                        </div>
                                        ...
                                        <div class="bg-gray-50 rounded-lg p-3 border border-gray-200">
                                            <div class="flex items-center gap-3 mb-3">
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <p class="text-xs text-gray-500">Click button to view or download</p>
                                                </div>
                                            </div>
                                            <div class="flex gap-2">
