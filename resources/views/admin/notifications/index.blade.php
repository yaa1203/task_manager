    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm sm:text-base text-gray-600">Stay updated with your system activities and important updates</p>
            </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6">
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
            <div class="p-5">
                ...
                <h3 class="text-sm font-medium text-gray-600 mb-1">All Notifications</h3>
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
            <div class="p-5">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <span class="px-3 py-1 bg-indigo-50 text-indigo-700 text-xs font-semibold rounded-full">Unread</span>
                </div>
                <h3 class="text-sm font-medium text-gray-600 mb-1">Need Attention</h3>
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
            <div class="p-5">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <span class="px-3 py-1 bg-green-50 text-green-700 text-xs font-semibold rounded-full">Read</span>
                </div>
                <h3 class="text-sm font-medium text-gray-600 mb-1">Already Read</h3>
                <p class="text-3xl font-bold text-gray-900">{{ $notifications->where('read_at', '!=', null)->count() }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="space-y-4">
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-16 text-center">
            <div class="max-w-sm mx-auto">
                ...
                <p class="text-sm text-gray-500 mb-6">You don't have any notifications at the moment. We'll notify you when something new comes up.</p>
