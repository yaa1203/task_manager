...
<div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6 sm:mb-8">
        ...
        <div class="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-lg shadow-lg p-5 text-white">
            ...
            <p class="text-sm opacity-90 mb-1">System Admins</p>
            <p class="text-3xl font-bold">{{ $admins->count() }}</p>
            <p class="text-xs opacity-75 mt-2">
        ...
        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-lg shadow-lg p-5 text-white">
            ...
            <p class="text-sm opacity-90 mb-1">New Users</p>
            ...
            <div class="px-5 sm:px-6 py-4 border-b border-gray-200 bg-gray-50">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="text-base sm:text-lg font-semibold text-gray-800">Latest Users</h2>
                            <p class="text-xs sm:text-sm text-gray-600">Recently registered</p>
                        </div>
                    </div>
                    <a href="{{ route('users.index') }}" class="text-xs sm:text-sm text-green-600 hover:text-green-800 font-medium transition">
                        View All →
                    </a>
                </div>
            </div>
                    ...
                    <li class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition group">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex items-center gap-1 text-xs text-gray-500">
                                ...
                                <span>•</span>
                                <span class="whitespace-nowrap">{{ $user->created_at->diffForHumans() }}</span>
                            </div>
                        </div>
