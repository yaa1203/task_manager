    ...
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm sm:text-base text-gray-600">Assign a task to users</p>
            </div>
            <div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <select id="user_ids" name="user_ids[]" multiple required
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 h-32">
                    ...
                    <div class="mt-4">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" name="assign_to_all" value="1" 
                                   class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                            <span class="text-sm font-medium text-gray-700">Assign to all users</span>
                        </label>
                        <p class="text-xs text-gray-500 mt-1">Check this to assign the task to all users (overrides individual selection)</p>
                    </div>
                </div>
