...
<body class="font-sans antialiased">
    <div class="min-h-screen flex">
        <!-- Left Side - Super Admin Register Form (Scrollable) -->
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="password" type="password" name="password"
                                   class="block w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 focus:outline-none transition text-sm sm:text-base bg-white"
        ...
        <!-- Right Side - Super Admin Hero Section (Fixed) -->
        <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-purple-600 via-purple-700 to-purple-800 fixed right-0 top-0 h-screen items-center justify-center p-12 overflow-hidden">
            <!-- Background Pattern -->
