                ...
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="text-xs text-gray-500">
                        <span class="inline-flex items-center gap-1">
                            ...
                            Terakhir diakses: {{ \Carbon\Carbon::now()->diffForHumans() }}
                        </span>
                    </div>
                </div>
                        ...
                        <div class="relative">
                            <div class="flex flex-col items-center text-center gap-3">
                                <div class="relative">
                                    ...
                                    @if($link['badge'])
                                    <span class="absolute -top-1 -right-1 bg-{{ $link['color'] }}-600 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center">
                                        {{ $link['badge'] }}
                                    </span>
                                    @endif
                                </div>
