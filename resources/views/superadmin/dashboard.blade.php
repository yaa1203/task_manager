        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
            <a href="#" 
               class="group flex flex-col items-center justify-center gap-2 p-4 sm:p-6 bg-white border-2 border-gray-200 rounded-xl hover:border-purple-500 hover:shadow-lg transition-all duration-200">
                ...
                <span class="text-sm font-semibold text-gray-700 group-hover:text-purple-600 text-center">Kelola Semua User</span>
            </a>
            ...
            <a href="#" 
               class="group flex flex-col items-center justify-center gap-2 p-4 sm:p-6 bg-white border-2 border-gray-200 rounded-xl hover:border-blue-500 hover:shadow-lg transition-all duration-200">
                ...
                <span class="text-sm font-semibold text-gray-700 group-hover:text-blue-600 text-center">Kelola Admin</span>
            </a>
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded-full">Users</span>
                </div>
                ...
                <p class="text-sm text-gray-500 flex items-center gap-1">
                    ...
                    <span class="text-green-600 font-medium">Semua user</span>
                </p>
            </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="px-3 py-1 bg-indigo-50 text-indigo-700 text-xs font-semibold rounded-full">Admins</span>
                </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="px-3 py-1 bg-purple-50 text-purple-700 text-xs font-semibold rounded-full">Super</span>
                </div>
            ...
            <div class="px-6 py-3 bg-gray-50 border-t border-gray-100">
                <a href="#" class="text-sm font-medium text-purple-600 hover:text-purple-700 flex items-center gap-1">
                    Lihat semua
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                    </svg>
