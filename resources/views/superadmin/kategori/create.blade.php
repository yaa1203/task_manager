...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-4 mb-4">
            ...
            <div>
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">Buat Kategori Baru</h1>
                <p class="text-sm text-gray-600">Tambahkan kategori baru untuk mengelompokkan pengguna</p>
            </div>
        </div>
    </div>
