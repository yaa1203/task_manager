...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Edit Kategori</h1>
                <p class="text-sm sm:text-base text-gray-600">Perbarui informasi kategori pengguna</p>
            </div>
        </div>
        {{-- Info Global --}}
        <div class="mb-6 p-4 bg-purple-50 border-l-4 border-purple-500 rounded-lg mt-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-purple-700 mt-0.5">Perubahan akan mempengaruhi semua pengguna yang terkait dengan kategori ini</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <form action="{{ route('categories.update', $category->id) }}" method="POST">
            ...
            <div class="p-6 border-b border-gray-100">
                ...
                <p class="mt-2 text-sm text-gray-500">Nama kategori saat ini: <span class="font-medium text-gray-700">{{ $category->name }}</span></p>
            </div>
